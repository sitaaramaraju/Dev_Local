...
=cut
		...
		print<<"EOF";
			...
			<html>
			<script language='javascript'>
				window.alert('No access. Please provide valid parameters.  Thank you.');
				document.location='http://centurylinkyoucandev.com/';
			</script>
EOF
		exit();	
		}
...
<body>
<form name='direct' method='post' action='/cgi-bin/lp-directional.cgi'>
