...
if ( $main::session{source_id} == 2 || $main::session{source_id} == 8) {#this is a qwesthr user, precedence will also be 20
...
print<<"EOF";
        <form name='launch' method='post' action='$launch_page'>
			...
			<input type='hidden' name='source_id' value='$main::session{source_id}'>
         </form>
    </body>
    </html>
EOF
