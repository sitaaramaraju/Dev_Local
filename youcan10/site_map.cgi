    	...
    	<div id="body-left-sec">
        	<div class="capsule-710">
                ...
                <div class="capsule-content">
                	<h4>My YOUCAN</h4>
                    <ul>
						<li><a href="https://www.myprepaidcenter.com/" target="_blank">YOUCAN Card Balance</a></li>
                    ...
                    <ul>
                    	<li><a href="#" onClick="document.lead123.action='mkt_materials.cgi';document.lead123.submit();">Marketing Materials</a></li>
                    </ul>
                    ...
                    <ul>	
                        ...
                        <li><a href="pdf/YouCan_Terms_and_Conditions_2016_Final.pdf" target="_blank">Terms &amp; Conditions</a></li>
                    </ul>
                </div>
            </div><!--END CAPSULE-->
