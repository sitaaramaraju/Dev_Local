...
my $thisfile = "index_pior.cgi";
my $acct =  $hs->parse($cgi->param('acct')) ||0;
my $from_email= '';#$cgi->param('from_email') || '';
my $how_did_you_hear = $hs->parse($cgi->param('how_did_you_hear')) ||0;
...
<head>
	...
	<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
		...
		<script  type="text/javascript" src="graf07/validate_pior.js"></script>
...
<div id="main">
	...
	<div id="masthead">
		...
		<ul id="topnav">
			...
			<li class="current"><a href="#" onClick="location.href='index_pior.cgi'"><font size="2">Home</font> </a>
EOF
		if ($redir == 1) {
print<<"EOF";
		...
		<input type="hidden" name="from_email" value="$from_email">
				...
				<ul>
				<li class="first"><a href="#"onclick="openModalLarge('graf07/promo_ctl.cgi?email=1&&acct=$acct&how_did_you_hear=$how_did_you_hear');return false;">Email</a></li>
				<li><a href="#"onclick="openModalLarge('graf07/promo_ctl.cgi?coupon=1&acct=$acct&how_did_you_hear=$how_did_you_hear');return false;">Coupon </a></li>
				</ul>
EOF
...
print<<"EOF";
			...
			<li><a href="#" onClick="document.frm.action='graf07/faq_pior.cgi';document.frm.submit();this.form.reset()" ><font size="2">FAQ&rsquo;s</font> </a>
			</li>
			<li><a href="#" onClick="document.frm.action='graf07/tandc_pior.cgi';document.frm.submit();this.form.reset()"><font size="2">Terms & Conditions</font> </a>
			</li>
		</ul>
		</div>
...
<div class="flashheader">
	...
	<ul>
	<li>You&rsquo;ll receive a \$50 bill credit for each new customer that signs up for CenturyLink High-Speed Internet&reg; or DIRECTV service through CenturyLink. </li>
	<li>You&rsquo;ll receive a \$25 bill credit for each existing CenturyLink customer that signs up for CenturyLink High-Speed Internet or DIRECTV service through CenturyLink.</li>
	<li>Double your credits when you refer your friends and family to sign up for new CenturyLink PRISM&trade; TV!</li>
		</ul>
<b>Plus, let your friends and family know they will get an extra \$10 off the current promotional price for 6 months!</b>
<p>
<p>More info? <a class="targetlink" href="graf07/faq_pior.cgi" >Read Frequently Asked Questions</a></p>
<p>&nbsp;</p>
<p>*Certain conditions may apply. <a href="graf07/tandc_pior.cgi">Click here for details.</a></p>
			</p>
			</td>
			</tr>
			</table>
...
if ($redir==1) {
	print<<"EOF";
<div class="menuitem"><h2><font size="5"><a href="#" onclick="openModalLarge('graf07/promo_ctl.cgi?email=1&&acct=$acct&how_did_you_hear=$how_did_you_hear');return false;">Email</a></font></h2></div>
...
if ($redir==1) {
	print<<"EOF";
<div class="menuitem"><h2><font size="5"><a href="#" onclick="openModalLarge('graf07/promo_ctl.cgi?coupon=1&&acct=$acct&how_did_you_hear=$how_did_you_hear');return false;">Print</a></font></h2></div>
...
if ($redir == 0) {
	print<<"EOF";
<p style="color: #666; font-weight: bold;">Your Account Number<br/>
<input type="text" name="acct" maxLength="10" onkeyup="acceptDigits(this);"> </p>
<p style="color:#666; font-weight: bold;">Confirm Your Account Number<br/>
<input type="text" name="acct2" maxLength="10" onkeyup="acceptDigits(this);"></p>
<br/>
<p style="color:#666; font-weight: bold;">How did you hear about our program?<br/>
<select name="how_did_you_hear">
<option value="" selected>Select one</option>
<option value="E-Mail">E-Mail</option>
<option value="Direct Mail to home">Direct Mail to home</option>
<option value="Telephone bill">Telephone bill</option>
<option value="Word of Mouth">Word of Mouth</option>
<option value="Other">Other</option>
</select></</p>
<br/><br/>
<input type="image" src="http://www.centurylink.com/static/Images/Buttons/btnSubmit.gif" border="0" width="86" height="29" alt="Submit" onclick="acceptDigits(acct);acceptDigits(acct2);checkform()"/>
EOF
...
<div class="support">
      	<p class="cta">Call us at 1 877-516-8478 </p>
</div> 
	</div>
</div>
