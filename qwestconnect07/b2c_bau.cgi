        ...
        <td background="images/background.gif"><table width="913" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td background="images/Subtitle_tile.gif"><table width="900" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="10">&nbsp;</td>
                <td align="left" valign="top" class="BlueTitles">Help us identify who you are:<!-- here here	--><br /></td>
              </tr>
            </table></td>
          </tr>
          <tr>
...
<input type="hidden" name="submitted" value="1">
                        ...
                        <tr>
                          <td width="20" align="left" valign="top"><input name="special"  type="radio" value="BAU"/></td>
                          <td align="left" valign="top" class="Enrollcopy">I am registering as an individual in the CenturyLink Referral Rewards Program.</td>
                        </tr>
                        <tr>
                          <td width="20" align="left" valign="top"><input name="special"  type="radio" value="B2C"/></td>
                          <td align="left" valign="top" class="Enrollcopy">I am registering on behalf of a business, corporation or organization in the CenturyLink Referral Rewards Program.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="left" valign="top">&nbsp;</td>
                          <td align="left" valign="top"><input name="Submit" type="submit" onclick="OnSubmitForm();return false;"  value="Continue..." />
							</td>
                        </tr>
						</form>
                      </table></td>
