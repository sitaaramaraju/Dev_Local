...
/* enroll.cgi */
    ...
    function checkform_bau() {
       ...
       // var myphone1 =  document.regi.home_phone1 + document.regi.home_phone2 + document.regi.home_phone3 ; // was using clean phone
		...
		if( document.regi.home_phone1.value == "" ||  document.regi.home_phone2.value == "" || document.regi.home_phone3.value == "" ) {
     		document.getElementById('req_hp').innerHTML='<font color=red>*Your Phone number could be your password, enter valid phone number.</font>';
			document.regi.home_phone1.focus();
            document.regi.redir.value = 0;
        }
		else {
			document.getElementById('req_hp').innerHTML='';
		}
		...
		if( document.regi.property_name.value == "") {
			...
			document.regi.property_name.focus();
            document.regi.redir.value = 0;
        }
		else {
...
for ( var i=0; i<regi_b2c.length; i++) {
	if (regi_b2c[i].checked) {
		...
		if( (document.regi_b2c.ssn1.value == "" || document.regi_b2c.ssn2.value=="" || document.regi_b2c.ssn3.value == "" )
			&& ( document.regi_b2c.ein1.value =="" || document.regi_b2c.ein2.value == "" ) ) { 
...
document.myform.action ="agreement.cgi";
		...
		if (answer){
			 $.ajax({
				...
				success: function(html){
						window.location='https://youcanuat.ccionline.biz/index_lmsii07.cgi';},
