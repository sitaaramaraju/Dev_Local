...
elsif ($ENV{HTTP_HOST} eq 'centurylinkconnect.ccionline.biz'){
    $server = "D:/centurylinkyoucan";
}
else {
    $server = "D:/centurylinkyoucan";
              ...
              <tr>
                ...
                <td align="left" valign="top" class="subTitles"><br />
                  <table width="700" border="0" align="center" cellpadding="1" cellspacing="1">
                    <tr>
                      <td colspan="3" align="left" valign="top" class="subTitles">CenturyLink&reg; Retail Referral Rewards Program Agreement</br> Effective May 20, 2016</span><br /></td>
                    </tr>
