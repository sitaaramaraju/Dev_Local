        ...
        <td background="images/background.gif"><table width="913" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td background="images/Subtitle_tile.gif"><table width="900" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="10">&nbsp;</td>
                <td align="left" valign="top" class="BlueTitles">How to Contact Us </td>
              </tr>
            </table></td>
          </tr>
          ...
          <tr>
            <td width="913" height="376" align="center" valign="top" background="images/Sub_tile.gif"><br />
                <br />
                    <br />
                      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
					  
              <tr>
                <td align="left" valign="top"><span class="BlueTitles">If you have reviewed the Frequently Asked Questions (FAQs) and you still have questions about the CenturyLink Partner Referral Program, there are two ways to contact us:
                 </span><br /> 
                  <br />
                  <ul>
                    <li>
                      <div class="Enrollcopy">Call the Referral Program Headquarters at 1 866-968-2261 and follow the prompts</div>
                      <br />
                    </li>
                    <li>
                      <div class="Enrollcopy">Fill out the <a href="#" onclick="openModalLarge('quickform.cgi');return false;" class="FAQLink" >Quick Contact Form</a><br />
                        <br />
                      </div>
                    </li>
                  </ul></td>
