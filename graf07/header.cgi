                ...
                <table width="954" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="left" valign="top">
                            <table width="954" border="0" cellspacing="0" cellpadding="0">
                                <tr >
                                    <td width="35" align="left" valign="top" background="images/nav_blank.gif">
                                        &nbsp;</td>
                                    <td width="187" align="left" valign="top" background="images/nav_blank.gif">
                                        <a href="../index_raf.cgi" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image28','','images/Sub_nav_home_on.gif',1)">
                                        <img src="images/Sub_nav_home_off.gif" name="Image28" width="187" height="31" border="0" id="Image28" /></a></td>										
                                    <td width="311" align="left" valign="top" background="images/nav_blank.gif">
                                        <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image29','','images/Sub_nav_about_on.gif',1)">
                                            <img src="images/Sub_nav_about_off.gif" name="Image29" width="311" height="31" border="0" id="Image29" onmouseover="MM_showMenu(window.mm_menu_0221111945_0,0,31,null,'Image29')" onmouseout="MM_startTimeout();" /></a></td>
                                    ...
                                    <td width="244" align="left" valign="top" background="images/nav_blank.gif">
                                        <a href="contact.cgi" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image31','','images/Sub_nav_contact_on.gif',1)">
                                            <img src="images/Sub_nav_contact_off.gif" name="Image31" width="244" height="31" border="0" id="Image31" /></a></td>
